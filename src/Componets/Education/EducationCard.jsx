  ...
  return (
    <>
      <div className="flex items-start gap-4 font-bold text-md text-white/75 border-4 border-white/35 rounded-xl">
        <img
          src={badge}
          className="w-15 h-15 bg-black rounded-full border-4 border-white/50 shadow absolute left-0 top-[-5px] translate-x-[-50%] mt-1"
        />
        <div className="bg-black/60 p-4 rounded-xl w-full gap-5">
          <h3 className="text-2xl text-amber-500/85">{achievement}</h3>
